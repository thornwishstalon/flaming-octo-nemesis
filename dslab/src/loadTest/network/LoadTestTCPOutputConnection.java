...
public class LoadTestTCPOutputConnection extends Thread implements IUserRelated{
	...
	public LoadTestTCPOutputConnection(Socket socket, ClientSetup setup){
		this.socket = socket;
